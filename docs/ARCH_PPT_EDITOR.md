...
> **更新日期**：2026-05-07  
> **分支**：`feat/ppt-editor`  
> **关联**：`docs/PLAN.md` Phase 6、`docs/ARCH_AGENT_SDK_NATIVE.md`（对话后端正式规格；工具底座由 `agent/tools/adapter.py` 复用既有 builtin/MCP provider）。原 `docs/ARCH_AGENT_GATEWAY.md` 工具层描述已废弃，相关 provider 代码本身保留。
